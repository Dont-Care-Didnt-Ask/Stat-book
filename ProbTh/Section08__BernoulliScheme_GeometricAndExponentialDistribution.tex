...
% Немножко агрессии:
% В некоторых источниках авторы вводят "<обобщённую схему Бернулли"> с переменной вероятностью успеха $p_k$, зависящей от номера испытания,
% впрочем, не утруждая себя явными проверками того, что получившийся набор вероятностей действительно является распределением 
% (т.е. сумма всех вероятностей равна 1) и прочими "<мелочами"> вроде честного пересчёта функции распределения.
